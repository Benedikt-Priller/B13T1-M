            ...
            \begin{itemize}[leftmargin=*]
                ...
                \item Grenzverhalten: \\[-2.0ex]{
                    \begin{align*}
                        ...
                        \lim\limits_{x \to -2^{-}} \arctan\left(\overbrace{\left[\dfrac{1}{\underbrace{x+2}_{\textcolor{myg}{0^{-}}}}\right]}^{\textcolor{myg}{-\infty}}\right) &= - \dfrac{\pi}{2}^{+}; \qquad \qquad \lim\limits_{x \to -2^{+}} \arctan\left(\overbrace{\left[\dfrac{1}{\underbrace{x+2}_{\textcolor{myg}{0^{+}}}}\right]}^{\textcolor{myg}{+\infty}}\right) &= \dfrac{\pi}{2}^{-} && \\[-2.0ex]
                    \end{align*}
                    }
                ...
                \item Zeichnung: \\[-2.0ex]{
                    ...
                    \begin{tikzpicture}[
                        ...
                        \node[anchor=south east] at (axis cs:{\Gtax},{0}) {\textcolor{myorange}{$G_{v_{1}}$}};
                        ...
                        % % h_3 für y3
                        % \pgfmathsetmacro{\Gtcy}{pi/2*(1/\yScale)}
                        % \addplot[thick, myorange] coordinates {(\xLowerLimitGraph,\Gtcy) (\xUpperLimitGraph,\Gtcy)};
                        % \node[anchor=south west] at (axis cs:{0},{\Gtcy}) {\textcolor{myorange}{$G_{h_{3}}$}};
                        \end{axis}
                    \end{tikzpicture}
                    }
                    }
        ...
        \item[h)] {
            ...
            \begin{itemize}[leftmargin=*]
                ...
                \item Krümmung: \\[-2.0ex]{
                    ...
                    $\Rightarrow \qquad G_{f}$ ist linksgekrümmt in $\left] \ -\infty; -\sqrt[2]{5} \ \right]$ sowie $\left[ \ \sqrt[2]{5}; +\infty \ \right[$ \\[1.0ex]
                    $\Rightarrow \qquad G_{f}$ ist rechtsgekrümmt in $\left[ \ -\sqrt[2]{5}; \sqrt[2]{5}\ \right]$\\[-2.0ex]
                    }
