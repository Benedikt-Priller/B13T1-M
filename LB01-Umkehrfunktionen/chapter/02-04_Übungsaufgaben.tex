    ...
    \item [2.]\begin{enumerate}[label=\alph*),leftmargin=*]
            ...
            \begin{itemize}[leftmargin=*]
                \item Definitionsmenge: \\[1.0ex]{
                    ...
                    \begin{align*}
                        ...
                        x_{1} &= -2 \ \text{\textit{(e)}}&&
                    \end{align*}
                    $\Rightarrow \quad \uuline{D_{f} = \mathbb{R} \setminus \left\{ -2 \right\}}$; \qquad Polstelle erster Ordnung mit VZW bei $x_{1} = -2$
                    }
                ...
                \item Grenzverhalten: \\[-2.0ex]{
                    \begin{align*}
                        ...
                        \lim\limits_{x \to -2^{-}} \arctan\left(\overbrace{\left[\dfrac{1}{\underbrace{x+2}_{\textcolor{myg}{0^{-}}}}\right]}^{\textcolor{myg}{-\infty}}\right) &= - \dfrac{\pi}{2}^{+}; \qquad \qquad \lim\limits_{x \to -2^{+}} \arctan\left(\overbrace{\left[\dfrac{1}{\underbrace{x+2}_{\textcolor{myg}{0^{+}}}}\right]}^{\textcolor{myg}{+\infty}}\right) &= \dfrac{\pi}{2}^{-} &&
                    \end{align*}
                    }
                \item Asymptoten: \\[-2.0ex]{
                    \begin{itemize}
                        \item Senkrechte Asymptoten: \quad {
                            \vspace{-5.0ex}
                            \begin{align*}
                                v_{1}(x): \quad &x = - 2
                            \end{align*}
                        ...
                        \item Waagerechte Asymptoten: \quad {
                            \vspace{-5.0ex}
                            \begin{align*}
                                h_{1}(x): \quad &y = - \dfrac{\pi}{2}\\[1.5ex]
                ...
                \item Monotonie: \\[-2.0ex]{
                    ...
                    \end{align*}
                    $z(x) = -1$; \qquad $n(x) = \left(x+2\right)^{2}$\\[1.0ex]
                    $f'(x) = 0 \qquad \Rightarrow \qquad z(x) < 0 \qquad \Rightarrow$ \quad keine Nullstellen\\[1.0ex]
                    \begin{minipage}[t]{0.4\linewidth}
                        \begin{align*}
                            n(x) &= 0 \\[2.0ex]
                            \left(x+2\right)^{2} &= 0 &&| \quad \pm \sqrt[2]{\phantom{x}}\\[1.5ex]
                            x+2 &= 0 &&| \quad -2\\[1.5ex]
                            x_{1} &= -2 \ \text{\textit{(d)}} &&\\[-1.5ex]
                        \end{align*}
                    \end{minipage}
                    \hfill
                    ...
                    \end{minipage}
                    $\Rightarrow \qquad G_{f}$ ist smf in $\left] \ -\infty; -2 \ \right[$ sowie $\left] \ -2; \infty \ \right[$\\[-2.0ex]
                    }
                \item Krümmung: \\[-2.0ex]{
                    \begin{align*}
                        f''(x) &= \dfrac{\left(x+2\right)^{2} \cdot 0 - \left(-1\right) \cdot 2 \cdot \left(x+2\right) \cdot 1}{\left[\left(x+2\right)^{2}\right]^{2}} &&\\[1.5ex]
                        &= \dfrac{2 \cdot \left(x + 2\right)}{\left(x+2\right)^{4}} &&\\[1.5ex]
                        &= \dfrac{2}{\left(x+2\right)^{3}} && \\[-1.5ex]
                    \end{align*}
                    $z(x) = 2$; \qquad $n(x) = \left(x+2\right)^{3}$\\[1.0ex]
                    $f''(x) = 0 \qquad \Rightarrow \qquad z(x) > 0 \qquad \Rightarrow$ \quad keine Nullstellen\\[1.0ex]
                    \begin{minipage}[t]{0.4\linewidth}
                        \begin{align*}
                            n(x) &= 0 \\[2.0ex]
                            \left(x+2\right)^{3} &= 0 &&| \quad \pm \sqrt[3]{\phantom{x}}\\[1.5ex]
                            x+2 &= 0 &&| \quad -2\\[1.5ex]
                            x_{1} &= -2 \ \text{\textit{(dr)}} &&\\[-1.5ex]
                        \end{align*}
                    \end{minipage}
                    \hfill
                    \begin{minipage}[t]{0.55\linewidth}
                ...
                \item Zeichnung: \\[-2.0ex]{
                    ...
                    \begin{tikzpicture}[
                        ...
                        \pgfmathsetmacro{\axisNegHeight}{-3.0};
        ...
        \item[h)] {
            ...
            \begin{itemize}[leftmargin=*]
                ...
                \item Grenzverhalten: \\[-2.0ex]{
                    \begin{align*}
                        \lim\limits_{x \to -\infty} \arctan\left(\overbrace{\sqrt[2]{\dfrac{1}{\underbrace{x^{2}+4}_{\textcolor{myg}{+\infty}}}}}^{\textcolor{myg}{0^{+}}}\right) &= 0^{+}; \qquad \qquad \lim\limits_{x \to +\infty} \arctan\left(\overbrace{\sqrt[2]{\dfrac{1}{\underbrace{x^{2}+4}_{\textcolor{myg}{+\infty}}}}}^{\textcolor{myg}{0^{+}}}\right) &= 0^{+} &&\\[-2.0ex]
                    \end{align*}
                    }
                \item Asymptoten: \\[-2.0ex]{
                    \begin{itemize}
                ...
                \item Monotonie: \\[-2.0ex]{
                    \begin{align*}
                        f'(x) &= \dfrac{1}{1 + \left(\sqrt[2]{\dfrac{1}{x^{2}+4}}\right)^{2}} \cdot \dfrac{1}{2} \cdot \dfrac{1}{\dfrac{1}{x^{2}+4}} \cdot \dfrac{\left(x^{2} + 4\right) \cdot 0 - 1 \cdot 2x}{\left(x^{2} + 4\right)^{2}} &&\\[1.5ex]
                        &= \dfrac{1}{1 + \dfrac{1}{x^{2}+4}} \cdot \dfrac{1}{2} \cdot \left(x^{2}+4\right) \cdot \dfrac{-2x}{\left(x^{2} + 4\right)^{2}} &&\\[1.5ex]
                        &= \dfrac{1}{1 + \dfrac{1}{x^{2}+4}} \cdot \dfrac{-x}{x^{2} + 4} &&\\[1.5ex]
                        &= \dfrac{-x}{x^{2} + 4 + 1} &&\\[1.5ex]
                        &= \dfrac{-x}{x^{2} + 5} &&\\[-2.0ex]
                    \end{align*}
                    $z(x) = -x$; \qquad $n(x) = x^{2} + 5$\\[1.0ex]
                    $f'(x) = 0$\\
                    \begin{minipage}[t]{0.4\linewidth}
                        \vspace{-2.0ex}
                        \begin{align*}
                ...
                \item Krümmung: \\[-2.0ex]{
                    \begin{align*}
                        f''(x) &= \dfrac{\left(x^{2} + 5\right) \cdot \left(-1\right) - \left(-x\right) \cdot 2x}{\left(x^{2} + 5\right)^{2}} &&\\[1.5ex]
                        &= \dfrac{-x^{2} - 5 + 2x^{2}}{\left(x^{2} + 5\right)^{2}} &&\\[1.5ex]
                        &= \dfrac{x^{2} - 5}{\left(x^{2} + 5\right)^{2}} &&\\[-2.0ex]
                    \end{align*}
                    $z(x) = x^{2} - 5$; \qquad $n(x) = \left(x^{2} + 5\right)^{2}$\\[1.0ex]
                    $f''(x) = 0$\\
                    \begin{minipage}[t]{0.4\linewidth}
                        \vspace{-2.0ex}
                        \begin{align*}
                        ...
                        \end{align*}
                        $x_{1} = -\sqrt[2]{5} \ \text{\textit{(e)}}; \quad x_{2} = \sqrt[2]{5} \ \text{\textit{(e)}}$\\
                    \end{minipage}
                    \hfill
                    \begin{minipage}[t]{0.55\linewidth}
                        \vspace{-2.0ex}
                    ...
                    \begin{tabularx}{0.95\linewidth}{c|X|X|X|X|X}
                        & $-\infty < x < -\sqrt[2]{5}$ & $x = -\sqrt[2]{5}$ & $-\sqrt[2]{5} < x < \sqrt[2]{5}$ & $x = \sqrt[2]{5}$ & $\sqrt[2]{5} < x < \infty$ \\ \hline
                        $z(x)$ & $-$ & $0$ & $+$ & $0$ & $-$ \\ \hline
                        $n(x)$ & $+$ & $+$ & $+$ & $+$ & $+$ \\ \hline
                        $f''(x)$ & $-$ & $0$ & $+$ & $0$ & $-$ \\ \hline
                        $G_{f}$ & r. g. & $W_{1}$ & l. g. & $W_{2}$ & r. g. \\
                    \end{tabularx}
                    }\\[2.0ex]
                    $\Rightarrow \qquad G_{f}$ ist rechtsgekrümmt in $\left] \ -\infty; -\sqrt[2]{5} \ \right]$ sowie $\left[ \ \sqrt[2]{5}; +\infty \ \right[$ \\[1.0ex]
                    $\Rightarrow \qquad G_{f}$ ist linksgekrümmt in $\left[ \ -\sqrt[2]{5}; \sqrt[2]{5}\ \right]$\\[-2.0ex]
                    }
                \item Extrem- und Wendepunkte: \\[-3.0ex]{
                    \begin{itemize}
                        \item Hochpunkt: \quad $H_{1}(0 \ / \ \SI{0.46}{})$
                        \item Wendepunkte: \quad $W_{1}(-\sqrt[2]{5} \ / \ \SI{0.32}{})$; \quad $W_{2}(\sqrt[2]{5} \ / \ \SI{0.32}{})$
                    \end{itemize}
                }
                \item Zeichnung: \\[-2.0ex]{
                    \raisebox{-\height}{
