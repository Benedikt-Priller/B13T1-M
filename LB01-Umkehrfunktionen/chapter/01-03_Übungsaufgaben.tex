    ...
    \item [b)]{
        ...
        \begin{itemize}[leftmargin=*]
            ...
            \item Verhalten am Rand von $D_{g}$:\\{
                \vspace{-2.0ex}
                \begin{align*}
                    \lim\limits_{x \to 0^{+}} ln\left(\dfrac{4 \cdot x}{x^{2} + 4}\right) &= \lim\limits_{x \to 0^{+}} ln\left(\overbrace{\dfrac{4}{2 \cdot x}}^{\textcolor{myg}{0^{+}}}\right) &= - \infty &&\\[2.0ex]
                    \lim\limits_{x \to \infty} ln\left(\dfrac{4 \cdot x}{x^{2} + 4}\right) &= \lim\limits_{x \to \infty} ln\left(\overbrace{\dfrac{4}{2 \cdot x}}^{\textcolor{myg}{0^{+}}}\right) &= -\infty &&
                \end{align*}
                }
        \end{itemize}
        }
    \item [c)]{
        ...
        \begin{itemize}[leftmargin=*]
            ...
            \item Verhalten am Rand von $D_{h}$:\\{
                \vspace{-2.0ex}
                \begin{align*}
                    \lim\limits_{x \to e^{+}} \sqrt[2]{ln\left(x\right) - 1} &= \lim\limits_{x \to e^{+}} \sqrt[2]{\underbrace{\underbrace{ln\left(x\right)}_{\textcolor{myg}{1^{+}}} - 1}_{\textcolor{myg}{0^{+}}}} &= 0^{+} &&\\[2.0ex]
                ...
                \begin{itemize}[leftmargin=*]
                    ...
                    \item Wertemenge von $f$: \\[2.0ex]{
                        ...
                        \begin{tabularx}{0.95\linewidth}{c|X|X|X|X|X|X|X|X}
                            ...
                            $f^{-1}(x)$ & n. d. & n. d. & $+$ & $+$ & $+$ & $0$ & $-$ \\                   
                        \end{tabularx}\\[3.0ex]
                        $D_{f^{-1}} = \uuline{W_{f} = \left] \ 0; \infty \ \right[}$\\
                        }
                    ...
                    \item Zeichnung: \\[-2.0ex]{
                        \begin{minipage}[t]{0.8\linewidth}
                            ...
                            \begin{tikzpicture}[
                                ...
                                % G_f_f^{-1}
                                \addplot[thick, myr, samples=1000, domain=0.001:0.96*\xUpperLimitGrid]
                                    {f_f1(x)};
