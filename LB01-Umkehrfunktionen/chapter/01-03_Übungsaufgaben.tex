    ...
    \item [b)]{
        ...
        \begin{itemize}[leftmargin=*]
            ...
            \item Verhalten am Rand von $D_{g}$:\\{
                \vspace{-2.0ex}
                \begin{align*}
                    \lim\limits_{x \to 0^{+}} \ln\left(\dfrac{4 \cdot x}{x^{2} + 4}\right) &= \lim\limits_{x \to 0^{+}} \left[\overbrace{\ln\left(4 \cdot x\right)}^{\textcolor{myg}{-\infty}} - \ln\left(\overbrace{x^{2} + 4}^{\textcolor{myg}{4^{+}}}\right)\right] &= - \infty &&\\[2.0ex]
