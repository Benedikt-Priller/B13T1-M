...
\begin{itemize}
    ...
    \item Krümmung und Wendepunkte: \\[-2.0ex]{
        \begin{align*}
            ...
            &= \dfrac{\left(-1\right) \cdot \left(-x^{2} + 2\right) \cdot \left(-x^{2} + 1\right)^{\frac{1}{2}} + x \cdot \left[-2x \cdot \left(-x^{2} + 1\right)^{\frac{1}{2}} + \dfrac{-x^{2} + 2}{\left(-x^{2} + 1\right)^{\frac{1}{2}}} \cdot \left(-x\right)\right]}{\left(-x^{2} + 2\right)^{2} \cdot \left[\left(-x^{2} + 1\right)^{\frac{1}{2}}\right]^{2}} &&\\[2.0ex]
            &= \dfrac{\left(-1\right) \cdot \left(-x^{2} + 2\right) \cdot \left(-x^{2} + 1\right) + x \cdot \left[-2x \cdot \left(-x^{2} + 1\right) + \dfrac{-x^{2} + 2}{1} \cdot \left(-x\right)\right]}{\left(-x^{2} + 1\right)^{\frac{1}{2}} \cdot \left(-x^{2} + 2\right)^{2} \cdot \left[\left(-x^{2} + 1\right)^{\frac{1}{2}}\right]^{2}} &&\\[2.0ex]
            &= \dfrac{\left(-1\right) \cdot \left(x^{4} - x^{2} - 2x^{2} +2\right) + x \cdot \left[2x^{3} - 2x + x^{3} - 2x\right]}{\left(-x^{2} + 2\right)^{2} \cdot \left(-x^{2} + 1\right)^{\frac{3}{2}}} &&\\[2.0ex]
            &= \dfrac{-x^{4} + x^{2} + 2x^{2} -2 + 2x^{4} - 2x^{2} + x^{4} - 2x^{2}}{\left(-x^{2} + 2\right)^{2} \cdot \left(-x^{2} + 1\right)^{\frac{3}{2}}} &&\\[2.0ex]
            &= \dfrac{2x^{4}-x^{2}-2}{\left(-x^{2} + 2\right)^{2} \cdot \left(-x^{2} + 1\right)^{\frac{3}{2}}} && \\[-2.0ex]
        \end{align*}
        }
